...
import static com.stockforum.project.exception.ErrorCode.INTERNAL_SERVER_ERROR;

@Slf4j
@RestControllerAdvice
public class GlobalControllerAdvice {
    // Application Exception
    @ExceptionHandler(ForumApplicationException.class)
    public ResponseEntity<?> errorHandler(ForumApplicationException e) {
